...
export var RegionBaseCoordinatesControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        let regionCoordinatesForm = L.DomUtil.create('form', 'leaflet-bar leaflet-control leaflet-control-custom form-inline', container);

        let formGroup = L.DomUtil.create('div', 'form-group', regionCoordinatesForm);
